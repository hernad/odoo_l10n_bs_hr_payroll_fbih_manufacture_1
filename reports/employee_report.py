...
#    _name = 'payroll.fbih_manufacture_1.report.wizard'
#
...
#        }
#        return self.env.ref('l10n_bs_hr_payroll_fbih_manufacture_1.action_payroll_fbih_manufacture_1_xlsx_report').report_action(self, data=data)


class PayrollFbReportPDFWizard(models.TransientModel):

    _name = 'payroll.fbih_manufacture_1.wizard.pdf'
    ...
    def action_print_pdf_report(self):
        ...
        return self.env.ref('l10n_bs_hr_payroll_fbih_manufacture_1.report_fbih_manufacture_1_pdf').report_action(self, data=data)
...
class EmployeeReportPDF(models.AbstractModel):
    ...
    _name = 'report.l10n_bs_hr_payroll_fbih_manufacture_1.payroll_fbih_manufacture_1_pdf_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        #report = self.env['ir.actions.report']._get_report_from_name('l10n_bs_hr_payroll_fbih_manufacture_1.report_fbih_manufacture_1_pdf')
...
#    _name = 'payroll.fbih_manufacture_1.report.xlsx'
...
#                'employee_ids': self.employee_ids.ids
#               }
#        return self.env.ref('l10n_bs_hr_payroll_fbih_manufacture_1.action_payroll_fbih_manufacture_1_pdf_report').report_action(self, data=data)
#
...
#
#        sheet = workbook.add_worksheet('Plate fbih_manufacture_1 Report')
