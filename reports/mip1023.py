...
class DateUtil:
    ...
    def default_date_to():
        ...
        to_date = DateUtil.previous_month(datetime.today().date())
...
class PayrollMip1023Wizard(models.TransientModel):
    ...
    def action_generate_xml(self):
        ...
        return self.env.ref('l10n_bs_hr_payroll_fbih_manufacture_1.mip1023_xml_report').report_action(self, data=data)

class Mip1023Xml(models.AbstractModel):

    # report.module.report_name
    _name = 'report.l10n_bs_hr_payroll_fbih_manufacture_1.mip1023_xml_template'
